...
ln -s /home/instore/xueersi hanshow
...
export CATALINA_HOME=/home/instore/xueersi/apache-tomcat-8.5.15
...
sh /home/instore/xueersi/integration/startup.sh
service integration start
systemctl daemon-reload
service integration start
cd /home/instore/xueersi/integration && java -Xms1024M -Xmx1024M -Djava.ext.dirs=lib com.hanshows.cdi.proxi.DataExtractor 1>/dev/null 2>&1
cd /home/instore/xueersi/integration && java -Xms1024M -Xmx1024M -Djava.ext.dirs=lib com.hanshows.cdi.proxi.DataExtractor
service integration start
vi /etc/init.d/integration
vi /etc/init.d/integration
service integration start
...
cat /etc/profile
wget -O /home/instore/xueersi/tomcat8.tar.gz export JAVA_HOME=/usr/local/java/jdk1.8.0_131
export JRE_HOME=${JAVA_HOME}/jre
export CLASSPATH=.:${JAVA_HOME}/lib:${JRE_HOME}/lib
export  PATH=${JAVA_HOME}/bin:$PATH
wget -O /home/instore/xueersi/tomcat.tar.gz http://ftp.meisei-u.ac.jp/mirror/apache/dist/tomcat/tomcat-8/v8.5.15/bin/apache-tomcat-8.5.15.tar.gz
curl 127.0.0.1:8080
wget -O /home/instore/xueersi/boost.7z https://jaist.dl.sourceforge.net/project/boost/boost/1.63.0/boost_1_63_0.7z
yum –y insta p7zip
...
vi ifcfg-eno1
cd /xueersi/apache-tomcat-8.5.15/bin
vi startup.sh
sudo vi /etc/rc.d/rc.local
mv jdk-8u131-linux-x64.tar.gz /xueersi/software/
sudo mv jdk-8u131-linux-x64.tar.gz /xueersi/software/
mv shopweb-plugin-abm-proxi-20170618.zip /xueersi/integration/
mv business_fields.properties /xueersi/apache-tomcat-8.5.15/webapps/shopweb/WEB-INF/classes/
cd component_script/
cd /xueersi/apache-tomcat-8.5.15/bin/
sudo chown instore:instore -R  apache-tomcat-8.5.15/
unzip shopweb-plugin-abm-proxi-20170618.zip
mv shopweb-plugin-abm-proxi-20170618 /xueersi/software/
unzip shopweb-plugin-abm-proxi-20170618.zip
mv shopweb-plugin-abm-proxi-20170618.zip /xueersi/software/
cd shopweb-plugin-abm-proxi-20170618/
mv business_fields.properties business_fields.properties.bak
mv  inits-config.js /xueersi/apache-tomcat-8.5.15/webapps/shopweb/hanshow-plugins-webpda/component_script/
cd /xueersi/apache-tomcat-8.5.15/bin/
mv /home/instore/inits-config.js /xueersi/apache-tomcat-8.5.15/webapps/shopweb/hanshow-plugins-webpda/component_script/
...
unzip template1.zip
cd template/
mv *.ttf /xueersi/eslworking-2.2.1/data/usr/fonts/
mv NORMAL_2*/ /xueersi/eslworking-2.2.1/data/usr/python/temp_json/
cd /xueersi/apache-tomcat-8.5.15/bin
vi startup.sh
sudo vi /etc/rc.d/rc.local
cd /xueersi/apache-tomcat-8.5.15/bin
