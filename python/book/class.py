...
import re
# str_ = '我是1.5T ，或者是1.5L'
# s2 = ['历史奶粉','奶粉勺','幼儿奶粉两桶','吴亦凡是牙签']
# k = list()
# for i in s2:
#     k.extend(re.findall('.*奶粉.*',i))
# print(k)
# a = re.findall('1.5[TL]',str_)

# s1 = '宝马S30,凯迪拉克CT6'
# a = re.findall('S(\d+ )',s1)

# s3 = '{ymd:"time",tianqi:"晴天"},{ymd:"time2",tianqi:"阴~小雨"}}'
# print(re.findall('tianqi:"(.*?)"',s3))

# s4 = 'who io fuck you'
# print(re.findall('\w*o\w*',s4),re.I)
