...
class CheXian_LiPei(SelenFun):
    ...
    def baoan(self):#OK 报案
        ...
        self.clickByCss("input[value='保单信息']")
        ...
        for h in __all:
            if h != __win:
                ...
                self.sendByCss("input[name='queryPolicyPolicyNo']", self.baodan)
                self.send_by_names("queryPolicyDamageDate_DAY",nowdate())
                self.clickByCss("input[value='查询']")
                self.swich2frame("name", "QueryResultFrame")
                self.clickByCsss("input[name='checkboxSelect']", 0)
                self.clickByCsss("input[name='checkboxSelect']", 1)
                self.clickByCss("input[value='新增']")
                self.alert_acc()
        ...
        self.clickByCss("input[name='registCarSubLosspersonflag'][value=\"0\"]")#否，是否有人伤

        self.clickByCss("input[name='registLossItemTypes'][tabIndex='13']") #本车车损
        self.clickByCss("input[name='registLossItemTypes'][tabIndex='22']") #第三者其它财产损失
        self.clickByCss("input[name='registLossItemTypes'][tabIndex='24']") # 第三者人员人伤医疗


        self.sendByCss("input[name='registDriverName']", SKNAME)
        self.sendByCss("input[name=\"registCollisionObject\"]", "止战之殇")
        self.sendByCss("input[name='registReportorPhoneNumber']", TEL)
        ...
        if self.location=="gps":
            ...
            for h in self.driver.window_handles:
                if h != win:
                    ...
                    time.sleep(4)
                    self.clickByCss("[value='搜索'][class='button']")
                    time.sleep(3)
                    self.clickByCss("[value='确定'][class='button']")
        ...
        self.clickByCss("input[value='生成出险摘要']")
        self.clickByCss("input[value='提交']")
        self.alert_acc()
        self.driver.switch_to.default_content()
        self.swich2frame("name","mainFrame")
        self.isExist(".tishi")
    ...
    def diaodu(self):#OK
        ...
        self.clickByCss("[name='selectPolicy][tabIndex='6']")
        ...
        self.clickByCss("[value='任务指派']")
        self.clickByCss("[value='提交']")
        self.driver.switch_to.default_content()
        self.swich2frame("name","mainFrame")
        try:
    ...
    def chakan(self):#OK查看
        ...
        self.driver.switch_to.default_content()
        self.swich2frame("name","leftFrame")
        self.clickByCss("a[title=\"理赔子系统\"]")
        self.clickByCss("a[title=\"查勘管理\"]")
        self.clickByCss("a[title=\"理赔子系统 >> 查勘管理 >> 查勘新增\"]")
        self.driver.switch_to.default_content()
        self.swich2frame("name","mainFrame")
        self.sendByCss("input[name='GcSurveyMainDtoRegistNo']", self.result_txt.get("报案号"))
        self.clickByCsss("input[value='查询']", 1)
        self.swich2frame("name", "QueryResultFrame")
        self.clickByCss("a[href='#']")
        self.driver.switch_to.default_content()
        self.swich2frame("name","mainFrame")
        ...
        self.clickByCss("input[name='gcCarSurveyPersonLossTypes0'][value='13']")#下肢骨折
        time.sleep(2)
        ...
        for h in self.driver.window_handles:
            if h != _win:
                self.driver.switch_to.window(h)
                self.clickByCss("input[name='gcSurveyCarDtoSelectFlag']")
    ...
    def dingsunxinzeng(self):# OK 车辆定损新增
        ...
        self.swich2frame("name","leftFrame")
        self.clickByCss("a[title=\"理赔子系统\"]")
        self.clickByCss("a[title=\"车险定损管理\"]")
        self.clickByCss("a[title=\"车辆定损管理\"]")
        self.clickByCss("a[title=\"理赔子系统 >> 车险定损管理 >> 车辆定损管理 >> 车辆定损新增\"]")
        self.driver.switch_to.default_content()
        self.swich2frame("name","mainFrame")
        self.sendByCss("input[name='gcRegistPolicyDtoRegistNo']", self.result_txt.get("报案号"))
    ...
    def caichandingsunxinzeng(self):#OK 财产定损新增
        ...
        self.driver.switch_to.default_content()
        self.swich2frame("name","leftFrame")
        self.clickByCss("[title=\"理赔子系统\"]")
        self.clickByCss("[title=\"车险定损管理\"]")
        self.clickByCss("[title=\"财产定损管理\"]")
        self.clickByCss("[title=\"理赔子系统 >> 车险定损管理 >> 财产定损管理 >> 财产定损新增\"]")
        self.driver.switch_to.default_content()
        self.swich2frame("name","mainFrame")
        self.sendByCss("input[name='gcRegistPolicyDtoRegistNo']", self.result_txt.get("报案号"))
        time.sleep(1)
    ...
    def pingjiyijiao(self):#平级移交 OK
        ...
        self.swich2frame("name","leftFrame")
        self.clickByCss("a[title=\"理赔子系统\"]")
        self.clickByCss("a[title=\"理赔子系统 >> 平级移交\"]")
        self.driver.switch_to.default_content()
        self.swich2frame("name","mainFrame")
        self.sendByCss("input[name=\"gcClaimStatusDetailDtoRegistNo\"]", self.result_txt.get("报案号"))
        _win = self.driver.current_window_handle
        self.clickByCss("input[value=\"查询\"]")
        self.swich2frame("name", "QueryResultFrame")
        self.clickByCsss("a[href=\"#\"]", 1)
        self.isWintwo()
        for h in self.driver.window_handles:
            if h !=_win:
                self.driver.switch_to.window(h)
    ...
    def renshanggenzong(self):# OK人伤跟踪新增
        ...
        self.swich2frame("name","leftFrame")
        self.clickByCss("a[title=\"理赔子系统\"]")
        self.clickByCss("a[title=\"人伤跟踪管理\"]")
        self.clickByCss("a[title=\"理赔子系统 >> 人伤跟踪管理 >> 人伤跟踪新增\"]")
        self.driver.switch_to.default_content()
        self.swich2frame("name","mainFrame")
    ...
    def shenjipingtai1(self):#审核批改
        ...
        self.driver.switch_to.default_content()
        self.swich2frame("name","leftFrame")
        self.clickByCss("a[title=\"审核平台子系统\"]")
        self.clickByCss("a[title=\"定核损审核\"]")
        self.clickByCss("a[title=\"审核平台子系统 >> 定核损审核 >> 待处理任务查询\"]")
        self.driver.switch_to.default_content()
        self.swich2frame("name","mainFrame")
        self.sendByCss("input[name='GwWfLogDtoContractNo']", self.result_txt.get("报案号"))
        self.clickByCss("input[value='查询(Q)']")
        self.swich2frame("name", "QueryResultFrame")
        self.clickByCss("a[href='#']")
        self.alert_acc()
        self.driver.switch_to.default_content()
        ...
        self.clickByCss("input[value='审核意见']")#点审核意见
        self.isWintwo()
        ...
        self.driver.switch_to.default_content()
        self.swich2frame("name","mainFrame")
        self.clickByCss("input[value='审核通过'][name='passBtn']")
        self.alert_acc()
        self.alert_acc()
        time.sleep(2)
        for h in  self.driver.window_handles:
    ...
    def shenjipingtai2(self): #OK
        ...
        self.clickByCss("input[value='审核意见'][name='butViewTranceInfo']")#点审核意见
        self.isWintwo()
        for h in self.driver.window_handles:
            if h != __win3:
                self.driver.switch_to.window(h)
        ...
        self.driver.switch_to.default_content()
        self.swich2frame("name","mainFrame")
        self.clickByCss("input[value='审核通过']")
        self.alert_acc()
        time.sleep(2)
    ...
    def yiliaoshenhe1(self):#OK
        ...
        self.swich2frame("name","leftFrame")
        self.clickByCss("a[title=\"审核平台子系统\"]")
        self.clickByCss("a[title=\"医疗审核\"]")
        self.clickByCss("a[title=\"审核平台子系统 >> 医疗审核 >> 待处理任务查询\"]")
        self.driver.switch_to.default_content()
        self.swich2frame("name","mainFrame")
        self.sendByCss("input[name='GwWfLogDtoContractNo']", self.result_txt.get("报案号"))
        self.clickByCss("input[value='查询(Q)']")
    ...
    def danzhengshouji(self):#O K单证收集
        ...
        self.swich2frame("name","leftFrame")
        self.clickByCss("a[title=\"理赔子系统\"]")
        self.clickByCss("a[title=\"单证收集管理\"]")
        self.clickByCss("a[title=\"理赔子系统 >> 单证收集管理 >> 单证待收集\"]")
        self.driver.switch_to.default_content()
        self.swich2frame("name","mainFrame")
        self.sendByCss("[name='queryRegistRegistNo']", self.result_txt.get("报案号"))
        self.clickByCss("[value='查询'][name='buttonQuery']")
        self.swich2frame("name", "QueryResultFrame")
        try:
        ...
        self.clickByCss("[name='save'][tabIndex='1']")#保存
        self.driver.switch_to.default_content()
        self.swich2frame("name","mainFrame")
    ...
    def lisuanxinzeng(self): #理算新增
        ...
        self.swich2frame("name","leftFrame")
        self.clickByCss("a[title=\"理赔子系统\"]")
        self.clickByCss("a[title=\"理算管理\"]")
        self.clickByCss("a[title=\"理赔子系统 >> 理算管理 >> 理算新增\"]")
        self.driver.switch_to.default_content()
        self.swich2frame("name","mainFrame")
        self.sendByCss("input[name='queryClaimRegistNo']", self.result_txt.get("报案号"))
        self.clickByCss("input[value='查询'][name='buttonQuery']")
        self.swich2frame("name", "QueryResultFrame")
        ...
        self.swich2frame("name","mainFrame")
        time.sleep(2)
        self.clickByCss("input[value='计算赔款金额'][name=\"calCompbutton\"]")#计算赔款金额
        time.sleep(1)
    ...
    def hepeishenhe(self):
        ...
        self.swich2frame("name","leftFrame")
        self.clickByCss("a[title=\"审核平台子系统\"]")
        self.clickByCss("a[title=\"核赔审核\"]")
        self.clickByCss("a[title=\"审核平台子系统 >> 核赔审核 >> 待处理任务查询\"]")
        self.driver.switch_to.default_content()
        self.swich2frame("name","mainFrame")
        self.sendByCss("input[name='GwWfLogDtoContractNo']", self.result_txt.get("报案号"))
        self.clickByCss("input[value='查询(Q)']")
...
class CheXian_ChongKai(SelenFun):
    ...
    def peikuanzhifushangchuan(self, SYJQ):#赔款支付上传
        ...
        self.clickByCss("a[title=\"理赔子系统\"]")
        self.clickByCss("a[title=\"重开赔案管理\"]")
        self.clickByCss("a[title=\"理赔子系统 >> 重开赔案管理 >> 重开赔案新增\"]")
        self.driver.switch_to.default_content()
        self.swich2frame("name","mainFrame")
        self.sendByCss("[name='closecaseRegistNo']", self.baoanhao)
        self.clickByCss("[name='buttonQuery']")
        self.swich2frame("name", "QueryResultFrame")

        if SYJQ == "SY":
            self.clickByCsss("a[href='#']", 0)
        if SYJQ == "JQ":
            self.clickByCsss("a[href='#']", 1)
        ...
        self.swich2frame("name","leftFrame")
        self.clickByCss("a[title=\"审核平台子系统\"]")
        self.clickByCss("a[title=\"重开赔案审核\"]")
        self.clickByCss("a[title=\"审核平台子系统 >> 重开赔案审核 >> 待处理任务查询\"]")
        self.driver.switch_to.default_content()
        self.swich2frame("name","mainFrame")
        self.send_by_names("GwWfLogDtoContractNo",self.baoanhao)
        self.clickByCss("[value='查询(Q)']")
        self.swich2frame("name", "QueryResultFrame")
        self.driver.find_elements_by_css_selector("a[href='#']")[0].click()
        self.driver.switch_to.default_content()
        self.swich2frame("name","mainFrame")
        ...
        Select(self.driver.find_element_by_name("NotionContent")).select_by_index(1) #同意
        __win = self.driver.current_window_handle
        self.clickByCss("[value='审核意见'][name='butViewTranceInfo']")
        self.isWintwo()
        for h in self.driver.window_handles:
            if h != __win:
                self.driver.switch_to.window(h)
    ...
    def lisuanbupei(self):#理算补赔
        ...
        self.clickByCss("a[title=\"理赔子系统\"]")
        self.clickByCss("a[title=\"理算管理\"]")
        self.clickByCss("a[title=\"理赔子系统 >> 理算管理 >> 理算补赔\"]")
        self.driver.switch_to.default_content()
        self.swich2frame("name","mainFrame")
        self.sendByCss("input[name='queryClaimRegistNo']", self.baoanhao)#输入报案号
        self.clickByCss("input[name='buttonQuery']")#点击查找
        self.swich2frame("name", "QueryResultFrame")
        ...
        self.clickByCss("[id='submitButton']")#提交submitButton
        self.alert_acc()
        self.driver.switch_to.default_content()
        self.swich2frame("name","mainFrame")
        time.sleep(1)
    ...
    def lisuanbupeishenhe(self):
        ...
        self.driver.switch_to.default_content()
        self.swich2frame("name","mainFrame")
        self.sendByCss("input[name='GwWfLogDtoContractNo']", self.baoanhao)#输入报案号
        self.click_by_names("buttonQuery")#点击查找
        self.swich2frame("name", "QueryResultFrame")
        self.clickByCsss("a[href='#']", 0)#点击查找到的第一条
       ...
       # else
        ...
        self.clickByCss("[value='审核意见'][name='butViewTranceInfo']")#点审核意见
        time.sleep(1)
        ...
        self.driver.switch_to.default_content()
        self.swich2frame("name","mainFrame")
        self.clickByCss("[value='审核通过'][name='passBtn']")
        self.alert_acc()
        # self.alert_acc()
        self.driver.switch_to.default_content()
        self.swich2frame("name","mainFrame")
...
class CheXian_ZhuXiao(SelenFun):
    ...
    def lianzhuxiao(self): #立案注销
        ...
        self.swich2frame("name","leftFrame")
        self.clickByCss("a[title=\"理赔子系统\"]")
        self.clickByCss("a[title=\"立案注销管理\"]")
        self.clickByCss("a[title=\"理赔子系统 >> 立案注销管理 >> 注销待处理\"]")
        self.driver.switch_to.default_content()
        self.swich2frame("name","mainFrame")
        self.sendByCss("input[name='queryRegistRegistNo']", self.result_txt.get("报案号"))
        self.clickByCss("input[name='buttonQuery']")

        self.swich2frame("name", "QueryResultFrame")
        self.clickByCsss("[href='#']", 0)
        # self.driver.find_elements_by_css_selector("")[0].click()
        self.alert_acc()
        self.driver.switch_to.default_content()
        self.swich2frame("name","mainFrame")
        ...
        self.sendByCss("[name='GcCancellationDtoApplyReasonName']", "04")
        self.keyud(VK_CODE['tab'])
        ...
        self.driver.switch_to.default_content()
        self.swich2frame("name","mainFrame")
        self.sendByCss("input[name='GcCancellationDtoApplyReasonName']", "04")
        self.keyud(VK_CODE['tab'])
        self.sendByCss("[name='GcCancellationDtoDetailInfo']", "红龙")
        self.clickByCss("[value='提交']")
        time.sleep(1.5)
        print(getfunname()+"\t")
    ...
    def zhuxiaoshenhe(self):
        ...
        self.swich2frame("name","leftFrame")
        self.clickByCss("a[title=\"审核平台子系统\"]")
        self.clickByCss("a[title=\"立案注销审核\"]")
        self.clickByCss("a[title=\"审核平台子系统 >> 立案注销审核 >> 待处理任务查询\"]")
        self.driver.switch_to.default_content()
        self.swich2frame("name","mainFrame")
        self.sendByCss("input[name='GwWfLogDtoContractNo']", self.result_txt.get("报案号"))
...
class CheXian_PiGai_关系人投保人(SelenFun):
    ...
    def pigaishenqin(self):
        ...
        self.driver.maximize_window()
        self.swich2frame("name","leftFrame")
        self.clickByCss("a[title=\"承保子系统\"]")
        self.clickByCss("a[title=\"批改管理\"]")
        self.clickByCss("a[title=\"承保子系统 >> 批改管理 >> 批改申请处理\"]")
        self.driver.switch_to.default_content()
        self.swich2frame("name", "mainFrame")
        ...
        self.swich2frame("name", "mainFrame")
        self.swich2frame("id", "myFrame")
        self.clickByCss("input[name='button_Risk_Open'][tabIndex='7']") #商业险详细信息
        time.sleep(5)
        self.swich2frame("name", "RiskFrame")
        self.swich2frame("id", "myFrame")
        self.driver.find_element_by_name("CalculateMotorOth").click()
    ...
    def 双核审核(self):
        ...
        self.swich2frame("name", "leftFrame")
        self.clickByCss("a[title=\"审核平台子系统\"]")
        self.clickByCss("a[title=\"核保审核\"]")
        self.clickByCss("a[title=\"审核平台子系统 >> 核保审核 >> 任务处理\"]")
        self.driver.switch_to.default_content()
        self.swich2frame("name", "mainFrame")
