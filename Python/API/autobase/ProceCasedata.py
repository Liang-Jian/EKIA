...
from autobase.Logger import Logi,AllFlowData
from autobase.SqlUtils import MsqService
from autobase.FunctionLibray import readYaml,randword,randomNum,randomTel,stuTel,calDate,midword,calClassDay,classTime,calWeekDay,sqlValue
...
def sql2str(s):
    ...
    print("SQl数据处理前:=%s" % removesql_str)
...
class CaseDataMap4Xls(object):
    ...
    def getFinallyReq(self, data):
        ...
        mainurl = readYaml("url")  # url

        templetepath = os.path.abspath('..') + '/autodata/template/' + vm_name
