...
# login_sginature = Signature().get_signature(json.loads(self.req[0]))
...
login_response = sess.post(url='https://pycmspre.lexue.com/system/sysUser/login', stream='True', data=json.loads(content), verify=False, timeout=4, headers=headerss)
