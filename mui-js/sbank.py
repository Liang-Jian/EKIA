...
class AndroidTest(object):
    def __init__(self):
        ...
        desired_caps['deviceName'] = 'SJE5T17B08000933'  # 刚才的devicename
        desired_caps['appPackage'] = 'com.tencent.mm'  # 计算器的package
        desired_caps['appActivity'] = 'com.tencent.mm.ui.LauncherUI'  # 计算器的activity
